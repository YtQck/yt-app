...
function video(q){
  ...
  function YT(id){
    getEl('YTPlayer', '<iframe id="ytplayer" type="text/html" width="100%" height="57%" src="https://www.youtube.com/embed/'+id+'?autoplay=1&color=white&showinfo=0&rel=0" allowfullscreen frameborder="0"></iframe>');
  }
  function vdImage(no){
